import 'package:app/lineChart.dart';
...
class HomeFemale extends StatefulWidget {
  ...
  @override
  _HomeFemaleState createState() => _HomeFemaleState();
}

class _HomeFemaleState extends State<HomeFemale> {
  String firstName = '';
